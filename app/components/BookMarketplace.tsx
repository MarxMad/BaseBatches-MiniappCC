...
import { USDC_ADDRESS, CAMPUS_COIN_ADDRESS } from '../constants/addresses';
import { CAMPUS_COIN_ABI, USDC_ABI } from '../constants/abis';
        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col space-y-4 md:flex-row md:items-center md:justify-between">
                <div>
                    ...
                    <p className="text-[#B8B8B8] mt-2">Descubre y comparte libros en el campus</p>
                </div>
                <button
            ...
            {books.length === 0 && (
                <div className="flex flex-col items-center justify-center py-16 px-4">
                    ...
                    <h3 className="text-xl font-bold text-white mb-2">No hay libros disponibles</h3>
